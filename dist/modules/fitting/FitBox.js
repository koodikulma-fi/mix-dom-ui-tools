...
// - Typing - //
import { FitBoxAlgoritms, cleanMargin, FitLocks } from "./FitBoxAlgoritms";
// - Component - //
//
...
export const FitBox = MixDOM.component(component => {
    let observer = null;
    const refElement = new Ref();
    component.state = {
        left: 0,
        top: 0,
        width: 0,
    ...
    const resizeBy = (targetRect) => {
        ...
        // Fit.
        const newState = FitBoxAlgoritms.fitToSize(targetRect, cRect, fitLocks, hAlgoritm, vAlgoritm);
    ...
    return () => {
        ...
        // Render.
        return (MixDOM.def("div", { className: classNames("m-size-fitter", component.props.className), _ref: refElement, style: style }, MixDOM.Content));
    };
});
